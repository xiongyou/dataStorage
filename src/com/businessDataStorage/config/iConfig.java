...
public interface iConfig {
	 ...
	 * @pdOid 4c6f4d7b-79ea-42bf-ad02-14c5463d99dc
	 */
	String getFieldMultiItemRegex(String platform, String object, String fieldName)
			throws Exception;
	 ...
	 * @pdOid 4c6f4d7b-79ea-42bf-ad02-14c5463d99dc
	 */
	String getErrorInfoText(String platform, String errorInfo)
			throws Exception;
	List<String> getCssSelectors(String platform) throws Exception;
	
	/**
	 * 获取某个平台下某个数据对象的开始位置正则表达式
	 * @param platform
	 * @param dataObject
	 * @return
	 */
	String getObjStartReg(String platform,String dataObject);
	
	/**
	 * 获取某个平台下某个数据对象的结束位置正则表达式
	 * @param platform
	 * @param dataObject
	 * @return
	 */
	String getObjEndReg(String platform,String dataObject);
